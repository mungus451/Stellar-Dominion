            ...
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-4 p-4">
                ...
                <main class="lg:col-span-3 space-y-6">
                    ...
                    <div class="content-box rounded-lg p-6 text-center">
                         ...
                         <a href="https://discord.gg/your-invite-code" target="_blank" class="inline-flex items-center bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-8 rounded-lg transition-colors text-lg">
